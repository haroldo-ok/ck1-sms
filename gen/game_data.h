...
extern const unsigned char lvl1_tiles[],lvl1_mtflags[],lvl1_map[],lvl1_items[],lvl1_entries[],lvl1_blocks[];
extern const unsigned int lvl1_mtdef[];
extern const unsigned int lvl1_yorps[];
extern const unsigned char lvl2_tiles[],lvl2_mtflags[],lvl2_map[],lvl2_items[],lvl2_entries[],lvl2_blocks[];
extern const unsigned int lvl2_mtdef[];
extern const unsigned int lvl2_yorps[];
extern const unsigned char lvl3_tiles[],lvl3_mtflags[],lvl3_map[],lvl3_items[],lvl3_entries[],lvl3_blocks[];
extern const unsigned int lvl3_mtdef[];
extern const unsigned int lvl3_yorps[];
extern const unsigned char lvl0_tiles[],lvl0_mtflags[],lvl0_map[],lvl0_items[],lvl0_entries[],lvl0_blocks[];
